...
.. mermaid::
    flowchart TD
      %% Main entry point
      id1(16S Amplicon Analysis) --> quality

      subgraph quality [Quality Control]
        direction LR
        id2("1. adapter removal<br/>⚙️ cutadapt") --> id3("2. trim reads<br/>⚙️ dada2")
      end
      ...
      subgraph DADA2 [DADA2 Pipeline]
        direction LR
        id4("3. learning errors<br/>⚙️ dada2") --> id5("4. sample inference<br/>⚙️ dada2")
        id5 --> id6("5. read merging<br/>⚙️ dada2")
        id6 --> id7("6. chimera removal<br/>⚙️ dada2")
      end

      DADA2 --> tax

      subgraph tax [Taxonomic Annotation]
        id8("7. assign taxonomy<br/>⚙️ IDTAXA")
      end
